...
# Originally exported from: HighSpeedRail-RRSv1.1b05Oct2021CommonData.xlsm
...
units = {
    "implementation unit": "HSR: km of track OR Air: Available Seat-km (ASK)",
